...
function FormSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const properties: Record<string, string> = {
      ...
      ist_lead_source: "CRM Playbook Download",
      product_list: "PPC & Social Ads Services",
      lifecyclestage: "subscriber", hs_lead_status: "NEW",
      website: pageUri,
    }
    try {
      const res = await fetch("/api/hubspot", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ properties, pageName: "CRM Playbook Download" }) })
