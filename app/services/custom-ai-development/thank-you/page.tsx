...
// ─── Page ──────────────────────────────────────────────────────────────────────
export default function CustomAIThankYouPage() {
  return (
    <>
      <Navigation />
      <main>
  ...
  const handleDownload = useCallback(async () => {
    try {
      const res = await fetch(
        "/assets/InsightsTap-Custom-AI-Development-Brochure.pdf"
      )
      if (res.ok) {
        ...
        a.href = url
        a.download = "InsightsTap-Custom-AI-Development-Brochure.pdf"
