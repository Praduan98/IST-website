...
export function Hero() {
  return (
    <section className="relative flex min-h-[85vh] flex-col items-center justify-center overflow-hidden bg-white pt-24 pb-12">
      ...
      <div className="glow-orb absolute left-1/2 top-[30%] h-[320px] w-[320px] sm:h-[500px] sm:w-[500px] lg:h-[700px] lg:w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#0dcfcf]/[0.07] blur-[60px] sm:blur-[160px]" />

      {/* Secondary orb — right side, lower */}
      <div
        className="glow-orb absolute right-[15%] top-[55%] hidden sm:block h-[500px] w-[500px] rounded-full bg-[#0dcfcf]/[0.05] blur-[140px]"
        style={{ animationDelay: "-4s" }}
      />

      {/* Tertiary orb — left side, subtle */}
      <div
        className="glow-orb absolute left-[10%] top-[65%] hidden sm:block h-[400px] w-[400px] rounded-full bg-[#0dcfcf]/[0.04] blur-[120px]"
        ...
        >
          <MagneticButton>
            <Link
              ...
              className="shimmer relative h-12 w-full sm:w-auto rounded-lg bg-[#0dcfcf] px-8 text-base font-medium text-white shadow-md shadow-[#0dcfcf]/15 transition-all hover:-translate-y-0.5 hover:bg-[#0a9a9a] hover:shadow-lg hover:shadow-[#0dcfcf]/25 inline-flex items-center justify-center"
            >
          ...
          <Link
            href="/Contact"
            className="h-12 w-full sm:w-auto rounded-lg border border-[#E2E8F0] bg-white px-8 text-base font-medium text-[#0F172A] transition-all hover:border-[#0dcfcf]/50 hover:bg-[#0dcfcf]/5 inline-flex items-center justify-center"
          >
...
function FloatingParticles() {
  ...
  // 8 particles on mobile, full 20 on desktop
  const mobileParticles = PARTICLE_POSITIONS.filter((_, i) => i % 3 === 0)
