...
export function FinalCTA() {
  return (
    <section id="book-call" className="relative overflow-hidden bg-white px-6 py-24 lg:py-32">
      {/* Background gradient */}
...
function CTAButton({
  ...
  return (
    <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
      <Link
        href={href}
        className={`inline-flex h-12 items-center gap-2 rounded-lg px-6 text-base font-medium transition-all sm:h-14 sm:px-8 ${
          primary
