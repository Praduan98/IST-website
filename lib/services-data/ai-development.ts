...
export const aiDevelopment: ServiceCategory = {
  ...
  services: [
    ...
    },
    {
      ...
      opening:
        "You have an AI use case that could be a product. We turn it into a production-ready SaaS application — multi-tenant architecture, subscription billing, user management, and AI capabilities that scale. From MVP to growth-stage product, we build AI-native SaaS that works.",
      metrics: [
